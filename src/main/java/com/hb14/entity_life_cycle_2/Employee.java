...
@Entity
@Table(name="employee")// zaten defauta bu isimde tablo olusacak neden @Table annotation'ni kullaniyorum?
                        // tamamen okunaklik ve bakildiginda direkt olarak anlayabilmek icin
