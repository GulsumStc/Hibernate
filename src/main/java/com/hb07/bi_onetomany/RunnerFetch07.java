...
//       String sqlQuery = " select  s.student_name, b.name from  student07 s inner join fetch book07 b on s.id = b.student_id ";
//
...
//       resultList1.forEach(t-> System.out.println(Arrays.toString(t)));
        ...
        // !!! yukardaki sorguyu HQL ile yazalım
            // hibernate iki farkli tablodan bahsediyorsam fetch kullamam gerek
//        String sqlQuery = " select s.name, b.name from Student07 s inner join fetch Book07 b on s.id = b.student.id ";
//        List<Object[]>  resultList2 = session.createQuery(sqlQuery).getResultList();
...
//        System.out.println("Silinen kayit sayisi : " + numOfDeletedRecords);  // child clasi sildigimden sorun olmadi

//
//        String sqlQuery2 = "DELETE FROM student07";
//        int numOfDeletedRecords2 = session.createSQLQuery(sqlQuery2).executeUpdate();
//        System.out.println("Silinen kayit sayisi : " + numOfDeletedRecords2);  // child clasi sildigimden sorun olmadi
...
//        System.out.println("Silinen kayit sayisi : " + numOfDeletedRecords5);
       ...
       // orphanRemoval
        student2.getBookList().set(0,null);// 101, 102 -->  null, 102
                                              // sifirinci indexteki book'u null'a cektiginden siler.
