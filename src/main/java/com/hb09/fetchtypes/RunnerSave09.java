...
public class RunnerSave09 {
    public static void main(String[] args) {
        ...
        /*
        !!! NOTE !!!
        Entity class'larimin herhangi birinde CASCADE methodlarindan herhangi bir tanesini
        eklersem iliskinin kurulabilmesi iin iki taraftan setleme islemi yapmam gerek.
        Eger yapmazsak Joincolum ile eklenen kolon null degerelr ile dolar
         */
        ...
        Serializable id = session.save(student1);// DB de kaydedilen objenin generate edilen id donuyor
                                                    // commit'ten sonra bile calisir.
        session.save(student2);
        session.save(student3);


        // session.persist(student1);// datatyi kalici hale getirmek, save methoduyla ayni ama void doner.
        // transaction ile commit arasinda kullanilmasi gerek
